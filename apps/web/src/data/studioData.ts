...
export const capabilities: Capability[] = [
  ...
  },
  {
    ...
    title: '16029 1000W gold/source 整柜参考模型',
    productType: '标准寄存柜',
    module: '整柜 / 门板 / 柜体 / 锁具 / 铰链',
    variants: '1000W 10/12/14 同尺寸源样本；只作为规则追溯和回归证据',
    status: 'reference_only',
    maturity: 'engineering_reference',
    generator: 'legacy evidence only',
    validation: 'gold/source SolidWorks visual QA + STEP/FCStd evidence, reference-only for current v43 internal sheet-metal handoff',
    parameters: ['door_count', 'cabinet_width', 'geometry_source'],
    evidence: ['DXF', 'STEP', 'SolidWorks', 'FreeCAD', 'BOM'],
    limitation:
      '该路线只保留为 gold/source 参考来源，不再作为工程师入口；当前交付以 740W / L642-R246 / v43 内部钣金 v18 包为准。',
  },
  {
