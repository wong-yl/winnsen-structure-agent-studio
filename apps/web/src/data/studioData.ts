...
export const projects: Project[] = [
  ...
  },
  {
    ...
    name: '16029 740W / L642-R246 / v43 内部钣金',
    productType: '标准寄存柜 / v43 内部钣金收尾包',
    status: 'v43-int-v18-lockfix 已作为当前交付入口；CAD 主线为 SolidWorks 2020',
    statusTone: 'good',
    sourceRoot: 'D:\\Winnsen_Structure_Agent_Studio\\workers\\generated_models\\review_generation_requests\\v43-int-v18-lockfix',
    ...
    risk: '当前 gate = PASS，用户已目视确认锁舌位置、后背居中接缝、内部层板/前框配合；仍不是生产图纸、DXF、BOM 或供应商工艺放行',
    updatedAt: '2026-06-03 16:30',
    stats: [
      { label: 'Route', value: 'v43', tone: 'good' },
      { label: 'Rows', value: 'L642-R246', tone: 'good' },
      { label: 'Outer size', value: '740×1917×550', tone: 'good' },
      { label: 'Lock tongue', value: '6 restored', tone: 'good' },
      { label: 'CAD', value: 'SW2020', tone: 'good' },
      { label: 'Gate', value: 'PASS', tone: 'good' },
    ],
    notes: [
      '当前只把 v43-int-v18-lockfix 放到平台主入口；v16/v17/v15 同路线试错包不作为当前下载入口。',
      '1000W 是 gold/source 结构参考；740W / L642-R246 / v43 是当前模板种子和交付路线，不把 800W/900W 称为标准。',
      'SolidWorks 当前主线按 2020 环境执行；FreeCAD 只作为内部证据/参数辅助。',
      '柜门钣金路线冻结；本轮只整理内部钣金配合和机械锁舌恢复。',
      '电器板、电控锁、电控锁钩不进入生成包；锁侧孔、定位孔、安装界面和基准保留。',
      '当前仍是 SW2020 工程复核包，不是生产图纸释放。',
    ],
  },
  {
    id: 'locker_23035_production_standard_v1',
    name: '23035 18/24 门生产图标准',
    productType: '标准副柜 / 生产图标准',
    status: '23035 18门与24门生产图标准已确认，所有关键结构口径无争议，可直接进入订单派生',
    statusTone: 'good',
    sourceRoot:
      'D:\\Winnsen_Structure_Agent_Studio\\workers\\analysis\\desktop_reference\\23035 18门副柜; D:\\Winnsen_Structure_Agent_Studio\\workers\\analysis\\desktop_reference\\23035 24门副柜(嵌墙式 1917×1000×550)',
    modelStatus: '18门/24门总装配均可用 SW2020 打开并作为订单侧柜派生标准；24门优先',
    progress: 93,
    capability: '18/24门生产图标准、SW2020 Pack-and-Go、订单派生映射、工程师审核包',
    risk: '无结构争议；14门主柜派生依据包已补齐，后续按该包确认最终室内 1917H 主柜落图',
    updatedAt: '2026-05-28 17:37',
    stats: [
      { label: '24门', value: 'ready', tone: 'good' },
      { label: '18门', value: 'ready', tone: 'good' },
      { label: 'CAD', value: 'SW2020', tone: 'good' },
      { label: 'Pack-and-Go', value: 'done', tone: 'good' },
    ],
    notes: [
      '24 门副柜是订单数量最多的派生目标，先按该生产图标准展开。',
      '18 门副柜按同一柜深和门/锁逻辑派生，不再走 STEP-only 口径。',
      '这两套是已确认的生产图标准，不是旧试错线或临时样件。',
    ],
  },
  {
    id: 'locker_26291437217_14door_main_derivation_v1',
    name: '26291437217 14门主柜派生包',
    productType: '订单主柜 / SolidWorks 派生依据包',
    status: '已生成 14门主柜 SolidWorks 2020 派生依据包，联合 16029 / 24030 / 24067 三类基准',
    statusTone: 'good',
    sourceRoot:
      'D:\\Winnsen_Structure_Agent_Studio\\workers\\handoffs\\ORDER_26291437217_14DOOR_MAIN_CABINET_DERIVATION_20260528',
    modelStatus: '16029 标准柜体、16029 中控门、24030 中控主柜、24067 14门主柜参考均已 Pack-and-Go；另含 20180530 14门 SLDPRT 基线',
    progress: 88,
    capability: '14门主柜派生依据、15寸屏/RFID/摄像头接口、标准柜体/门锁/维护门逻辑、工程师审核说明',
    risk: '24067 是户外 1939H 参考，只取 14门主柜结构组织和中控关系；不得直接当成本单 1917H 室内主柜最终几何',
    updatedAt: '2026-05-28 19:20',
    stats: [
      { label: 'SW refs', value: '4 packs', tone: 'good' },
      { label: 'SLDASM', value: '111', tone: 'good' },
      { label: 'SLDPRT', value: '341', tone: 'good' },
      { label: 'ZIP', value: '204MB', tone: 'good' },
    ],
    notes: [
      '16029 标准柜体用于 1917×1000×550 标准柜体、门、锁、维护门和走线基础规律。',
      '24030 与 16029 中控门模块用于 15寸屏、RFID、读卡器/摄像头、拆换面板和中控门维护逻辑。',
      '24067 完整 14门主柜只作为 14门主柜组织关系参考，户外防水/雨棚/太阳能顶和 1939H 尺寸不进入本单默认结构。',
      '包内 README_DERIVATION.md 和 ENGINEER_REVIEW_SCOPE.md 已写清工程师审核边界。',
    ],
  },
  {
    ...
    statusTone: 'warn',
    sourceRoot: 'C:\\Users\\Administrator\\Desktop\\户外柜参数化模板素材_U盘原始_20260526',
...
export const pipelineRows: PipelineRow[] = [
  ...
  },
  {
    stage: '可生成模型',
    owner: 'generator',
    locker16029: '800W gold-variable LMS/SML review packages gated; 1000W 10/12/14 retained as gold/source reference',
...
export const ruleFamilies: RuleFamily[] = [
  ...
  },
  {
    ...
    evidence: ['SolidWorks', 'DXF', 'BOM', '工程图'],
    status: '23054, 24030, 25072 control-cabinet templates discovered; 26291437217 14-door main derivation package generated from 16029/24030/24067',
    nextAction: 'Use the 14-door derivation package README boundary: 16029 for standard cabinet body, 24030/16029 operation module for interfaces, and 24067 only for complete 14-door organization.',
  },
  {
...
export const templateAssets: TemplateAsset[] = [
  ...
  },
  {
    ...
    sourceAssemblyPath:
      'C:\\Users\\Administrator\\Desktop\\参数化模板素材_U盘原始_20260526\\16029 寄存柜(标准组合式 1917×1000×550)\\1.工程图\\标准寄存柜1917×1000×550(总装配).SLDASM',
  ...
  {
    id: 'TPL-16029-14DOOR-ORDER-BASIS-20180530',
    title: '16029 14门订单配置保存基线',
    productType: '标准寄存柜 / 14门基线',
    size: '1917x1000x550',
    variants: '14门 saved-part 订单配置基线',
    sourceAssemblyPath:
      'C:\\Users\\Administrator\\Desktop\\参数化模板素材_U盘原始_20260526\\16029 寄存柜(标准组合式 1917×1000×550)\\10.备份\\1.工程图20190423\\█订单配置\\20180530标准寄存柜(总装配)西班牙14门.SLDPRT',
    bomPath: '█订单配置\\20180530 对应备份线索',
    dxfPath: '10.备份\\1.工程图20190423\\█订单配置',
    stepOrPdfPath: 'SLDPRT saved-part baseline, not a full assembly',
    ruleLearningValue: '高',
    ruleFocus: ['14门几何基线', '保存零件线索', '与 16029 标准柜体映射', '非 STEP 交付'],
    evidence: ['SolidWorks', '工程图'],
    status: 'ready_for_rule_learning',
  },
  {
    id: 'TPL-23035-24-STD-1917x1000x550',
    title: '23035 24门副柜生产图标准',
    productType: '标准副柜 / 生产图标准',
    size: '1917x1000x550',
    variants: '24门生产图标准，订单 5 套优先',
    sourceAssemblyPath:
      'D:\\Winnsen_Structure_Agent_Studio\\workers\\analysis\\desktop_reference\\23035 24门副柜(嵌墙式 1917×1000×550)\\23035 24门副柜(嵌墙式 1917×1000×550)\\A.工程图 24门副柜\\嵌墙寄存柜1917×1000×550(总装配).SLDASM',
    bomPath: 'C.BOM\\23035 寄存柜(嵌墙式 机械加工BOM) 24门副柜.xlsx',
    dxfPath: 'B.钣金展开图',
    stepOrPdfPath: 'D.PDF图纸 + E.STEP图',
    ruleLearningValue: '高',
    ruleFocus: ['24门生产图标准', '门框/锁位/维护门逻辑', '嵌墙式到标准柜映射', '与18门共用外形边界'],
    evidence: ['SolidWorks', 'DXF', 'BOM', 'STEP', '工程图'],
    status: 'ready_for_rule_learning',
  },
  {
    id: 'TPL-23035-18-STD-1917x1000x550',
    title: '23035 18门副柜生产图标准',
    productType: '标准副柜 / 生产图标准',
    size: '1917x1000x550',
    variants: '18门生产图标准，订单 1 套',
    sourceAssemblyPath:
      'D:\\Winnsen_Structure_Agent_Studio\\workers\\analysis\\desktop_reference\\23035 18门副柜\\23035 18门副柜\\A.工程图 18门副柜\\嵌墙寄存柜1917×1000×550(总装配).SLDASM',
    bomPath: 'C.BOM\\23035 18门副柜BOM表.xlsx + 23035 18门副柜机箱配件BOM表.xlsx',
    dxfPath: 'B.钣金展开图',
    stepOrPdfPath: 'D.PDF图纸 + E.step 简化图',
    ruleLearningValue: '高',
    ruleFocus: ['18门生产图标准', '门框/锁位/维护门逻辑', '嵌墙式到标准柜映射', '与24门共用外形边界'],
    evidence: ['SolidWorks', 'DXF', 'BOM', 'STEP', '工程图'],
    status: 'ready_for_rule_learning',
  },
  {
    id: 'TPL-24030-CONTROL-1917x482x550',
    title: '24030 寄存控制主柜 6 门中控模板',
    productType: '控制主柜 / 中控模板',
    size: '1917x482x550',
    variants: '6门控制主柜',
    sourceAssemblyPath:
      'C:\\Users\\Administrator\\Desktop\\参数化模板素材_U盘原始_20260526\\24030 寄存控制主柜6门(1917×482×550)\\Ⅰ.工程图\\寄存控制主柜6门(1917×482×550).SLDASM',
    bomPath: '3.BOM + 订单配置 BOM',
    dxfPath: 'Ⅱ.钣金展开图',
    stepOrPdfPath: 'Ⅳ.PDF图纸 + Ⅴ.简化 STEP',
    ruleLearningValue: '高',
    ruleFocus: ['15寸屏', 'RFID', '读卡器', '摄像头', '中控门', '走线', '电源/锁控板'],
    evidence: ['SolidWorks', 'DXF', 'BOM', 'STEP', '工程图'],
    status: 'ready_for_rule_learning',
  },
  {
    id: 'TPL-24067-14DOOR-QTRAK-1939x1000x550',
    title: '24067 户外快递主柜 14 门完整参考',
    productType: '主柜 / 14门完整参考',
    size: '1939x1000x550',
    variants: '14门户外 QTRAK 参考',
    sourceAssemblyPath:
      'C:\\Users\\Administrator\\Desktop\\户外柜参数化模板素材_U盘原始_20260526\\24067 户外快递主柜14门(1939×1000×550)美国QTRAK\\1.工程图\\户外快递主柜14门(1939×1000×550).SLDASM',
    bomPath: '3.BOM',
    dxfPath: '2.钣金展开图',
    stepOrPdfPath: '4.PDF图纸 + 5.step简化图',
    ruleLearningValue: '高',
    ruleFocus: ['完整14门组织', '中控门', '锁控板', '维护门', '走线', '户外防水结构仅作参考'],
    evidence: ['SolidWorks', 'DXF', 'BOM', 'STEP', '工程图'],
    status: 'ready_for_rule_learning',
  },
  {
...
export const ruleLearningAxes: RuleLearningAxis[] = [
  {
    ...
    currentState: '16029 1000W 10/12/14 同尺寸样机是 gold/source 参考基准；当前工程交付口径已切到 740W / L642-R246 / v43 内部钣金包。',
    nextAction: 'gold/source 样机只用于追溯规则来源和几何对照；新增交付必须回到 gold-variable 生成与 finalize 固定入口。',
    maturity: 'step_bbox_measured',
...
export const capabilities: Capability[] = [
  {
    ...
    variants: '16038 多门数样本；16029 1000W 10/12/14 gold/source 仅作规则来源',
    status: 'queued',
    maturity: 'mapped',
  ...
  {
    id: 'locker_16029_v43_internal_sheetmetal_current',
    title: '16029 740W v43 内部钣金当前交付包',
    productType: '标准寄存柜',
    module: '整柜 / 内部钣金 / 锁舌 / 后背接缝 / 层板前框',
    variants: '740W / L642-R246 / v43 / 6 门；柜门钣金冻结，内部钣金配合修正',
    status: 'generatable',
    maturity: 'manual_review_required',
    generator: 'tools\\generate_review_solidworks_full_assembly.ps1',
    validation: 'v43 delivery manifest gate + 1000W gold/source structure gate + structure feedback + SolidWorks 2020 review',
    parameters: ['cabinet_width=740', 'row_sequence=L642-R246', 'request_id=v43-int-v18-lockfix'],
    evidence: ['SolidWorks', '证据闭环记录'],
    limitation: '当前包可进入 SolidWorks 2020 工程复核和交付整理；不是生产图纸释放。电器板、电控锁、电控锁钩不进入生成包，只保留锁侧孔位、定位孔、安装界面和 datum。',
  },
  {
    id: 'locker_16029_gold_variable_current',
    title: '16029 800W gold-variable 历史参考包',
    productType: '标准寄存柜',
    ...
    validation: 'historical model gate + STEP bbox gate + SolidWorks 2020 open screenshot gate',
    parameters: ['variant_token', 'row_units'],
    evidence: ['STEP', 'SolidWorks', '证据闭环记录'],
    limitation: '该 800W LMS/SML/DUAL 线保留为历史参考，不再作为当前主入口。当前交付以 740W / L642-R246 / v43 内部钣金 v18 包为准。',
  },
  {
  ...
  },
  {
    ...
    title: '16029 受控钣金整柜生成 / 1000W 金标准复核',
    productType: '标准寄存柜',
    module: '整柜 / 门板 / 柜体 / 锁具 / 铰链',
    variants: 'v43 L642-R246: 700-780W/550D/6门；gold-rule: 740-1100W/350-600D/10/12/14门',
    status: 'generatable',
    maturity: 'engineering_reference',
    generator: 'tools\\process_16029_review_generation_queue.mjs / controlled 16029 sheet-metal policy',
    validation: 'controlled combo policy + 1000W gold/source structure gate + SolidWorks 2020 review',
    parameters: ['door_count', 'cabinet_width', 'cabinet_depth', 'geometry_source'],
    evidence: ['DXF', 'STEP', 'SolidWorks', 'FreeCAD', 'BOM'],
    limitation:
      '不是固定三点白名单，也不是无约束随机生成；平台按已抽取钣金规则做宽深派生，生成后仍由 box/electrical/1000W gold gate 阻断低质量包。电器板、电控锁、电控锁钩不进入生成包，只保留孔位、定位和安装 datum。',
  },
  {
    ...
    productType: '标准寄存柜',
    module: 'ordinary_door',
    variants: '历史单门板与宽度候选证据；当前审核包使用 740W / L642-R246 / v43 路线',
    status: 'reference_only',
    maturity: 'engineering_reference',
...
export const reviewItems: ReviewItem[] = [
  {
    id: 'V43-P0-16029-FINAL-PACKAGE-SCOPE',
    project: '16029 740W / L642-R246 / v43',
    module: 'current SW2020 package',
    priority: 'P1',
    severity: '严重',
    issue: '当前交付入口只使用 v43-int-v18-lockfix；v15/v16/v17 同路线试错包不再作为当前下载入口。',
    nextAction: '工程复核时优先打开 v18 Pack-and-Go 主装配；旧包只保留为历史对照，不转发给工程师作为当前包。',
    evidence: ['SolidWorks', '证据闭环记录'],
    status: 'watching',
  },
  {
    id: 'V43-P1-16029-LOCK-TONGUE-AND-ELECTRIC-EXCLUSION',
    project: '16029 740W / L642-R246 / v43',
    module: 'lock interface',
    priority: 'P1',
    severity: '严重',
    issue: '6 个机械锁舌已恢复；电器板、电控锁、电控锁钩仍排除，锁侧孔位、定位孔、安装 datum 保留。',
    nextAction: '继续要求后续生成包通过 door lock tongue gate 和 electrical/electric-lock component count = 0 检查。',
    evidence: ['SolidWorks', '证据闭环记录'],
    status: 'watching',
  },
  {
    id: 'V43-P1-16029-PRODUCTION-RELEASE-BOUNDARY',
    project: '16029 740W / L642-R246 / v43',
    module: 'handoff boundary',
    priority: 'P1',
    severity: '严重',
    issue: '当前状态是 SW2020 工程复核和交付整理，不是生产图纸、DXF、BOM 或供应商工艺放行。',
    nextAction: '需要生产释放时，单独补 SLDDRW、DXF/展开图、BOM、材料厚度、公差和供应商工艺确认。',
    evidence: ['SolidWorks', '工程图', '证据闭环记录'],
    status: 'open',
  },
  {
  ...
  {
    id: 'STD-P1-16029-BBOX-ENVELOPE-SIGNOFF',
    project: '16029 800W gold-variable',
    module: 'nominal envelope / STEP bbox',
    priority: 'P1',
    severity: '严重',
    issue: '名义柜体外形为 800W×1917H×550D，但 LMS/SML raw STEP assembly bbox 为 800×1983×553.5；已定位为底脚 Y=-60、顶部对象 Y=1923、前侧五金 Z=+3.5',
    nextAction: '结构工程师确认生产/客户口径使用名义柜体外形还是含底脚、顶部和前侧外伸的安装外形；确认后再进入生产图纸释放。',
    evidence: ['STEP', 'SolidWorks', '证据闭环记录'],
    status: 'open',
  },
  {
...
export const metricCards = [
  {
    label: '当前主线',
    value: '740W v43',
    detail: 'L642-R246 / 内部钣金最终包',
    tone: 'good',
  },
  {
    label: '当前尺寸',
    value: '740W',
    detail: '1917H × 550D / v43 柜门路线冻结',
    tone: 'good',
  },
  {
    label: '审核包',
    value: '1 ZIP',
    detail: 'v43-int-v18-lockfix',
    tone: 'good',
  },
  {
    label: '生成入口',
    value: 'SW2020',
    detail: 'full assembly generator + delivery manifest gate',
    tone: 'warn',
  },
  { label: '当前 Gate', value: 'PASS', detail: '锁舌 6 / 电器件 0 / 反馈 clean', tone: 'good' },
]
