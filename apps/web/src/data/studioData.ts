...
export const projects: Project[] = [
  ...
  },
  {
    ...
    risk: '当前 scope gate = PASS：LMS/SML 已有 SolidWorks 2020 打开截图和 JSON 证据；名义 1917H 与 raw STEP bbox 1983H 的底脚/顶部/前侧外伸需要工程师签核',
    updatedAt: '2026-05-28 14:42',
    stats: [
    ...
    notes: [
      ...
      '1000W / 10/12/14 是 gold/source 参考基准，不是废线；当前工程师下载口径仍只放 800W LMS/SML/DUAL。',
      ...
      'STEP raw bbox 为 800 × 1983 × 553.5，其中 Y=-60..1923 来自底脚和顶部对象，Z 前侧 +3.5 来自小五金外伸；这不是自动生产释放结论，需要工程师确认名义外形和安装外形口径。',
  ...
  },
  {
    ...
    statusTone: 'good',
    sourceRoot:
      'C:\\Users\\Administrator\\Desktop\\23035 18门副柜; C:\\Users\\Administrator\\Desktop\\23035 24门副柜(嵌墙式 1917×1000×550)',
...
export const templateAssets: TemplateAsset[] = [
  ...
  },
  {
    ...
    sourceAssemblyPath:
      'C:\\Users\\Administrator\\Desktop\\23035 24门副柜(嵌墙式 1917×1000×550)\\23035 24门副柜(嵌墙式 1917×1000×550)\\A.工程图 24门副柜\\嵌墙寄存柜1917×1000×550(总装配).SLDASM',
  ...
  },
  {
    ...
    sourceAssemblyPath:
      'C:\\Users\\Administrator\\Desktop\\23035 18门副柜\\23035 18门副柜\\A.工程图 18门副柜\\嵌墙寄存柜1917×1000×550(总装配).SLDASM',
...
export const ruleLearningAxes: RuleLearningAxis[] = [
  {
    ...
    currentState: '16029 1000W 10/12/14 同尺寸样机是 gold/source 参考基准；当前工程交付口径已切到 800W gold-variable LMS/SML。',
...
export const capabilities: Capability[] = [
  ...
  },
  {
    ...
    limitation: '当前是可审核包，不是生产图纸释放；名义柜体外形为 800W×1917H×550D，raw STEP bbox 包含底脚、顶部和前侧五金外伸，需要工程师确认外形口径。新增变体仍只能改 variant_token 和 row_units，并重新跑 model gate、STEP bbox gate、SolidWorks 2020 open gate 与 handoff scope gate。',
  },
  {
  ...
  },
  {
    ...
    validation: 'gold/source SolidWorks visual QA + STEP/FCStd evidence, reference-only for current 800W handoff',
    parameters: ['door_count', 'cabinet_width', 'geometry_source'],
    evidence: ['DXF', 'STEP', 'SolidWorks', 'FreeCAD', 'BOM'],
    limitation:
      '该路线只保留为 gold/source 参考来源，不再作为工程师入口；当前交付以 800W gold-variable LMS/SML/DUAL 审核包为准。',
  },
  {
